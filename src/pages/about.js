...
const about = () => {
  return (
    <>
      <Head>
        <title>Dee | About Page</title>
        <meta name="Description" content="Description" />
      </Head>
      <TransitionEffect />
      <main className="flex w-full flex-col item-center justify-center dark:text-light">
        <Layout className="pt-16">
          <AnimatedText text="Aspire to Inspire" className="mb-16 lg:!text-7xl sm:!text-6xl xs!text-4xl sm:mb-8" />
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="my-4 font-medium">
                ...
                with the analytical power of coding. I envision a world where technology acts as a stage
                for enhanced organization and boundless imagination.
              </p>
