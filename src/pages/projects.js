...
import project2 from "../../public/images/projects/Restuarant-Website.png";
import project3 from "../../public/images/projects/E-Commerce Site.png";
...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    ...
    >
      <div
        className="absolute top-0 -right-3 -z-10 w-[100%] h-[103%] rounded-[2rem] bg-dark dark:bg-light
...
const projects = () => {
  return (
    <>
      <Head>
        <title>Dee | Projects Page</title>
        <meta name="Description" content="Description" />
      </Head>
      <TransitionEffect />
      <main className="w-full mb-16 flex flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          <AnimatedText text="Imagination Is Key" className="mb-16 lg:!text-7xl sm:mb-8 sm!text-6xl xs:!text-4xl
