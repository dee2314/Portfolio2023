...
<nav>
      ...
      <nav className="flex items-center justify-center flex-wrap-reverse mt-2">
        <motion.a href="https://twitter.com/Deviantsdd" target={"_blank"}
        whileHover={{ y:-2 }}
        whileTap={{scale:0.9}}
      ...
      ${mode === "light" ? "bg-dark text-light" : "bg-lug" }
      `}
      >
    {
      mode === "dark" ?
...
<nav className="flex items-center flex-col justify-center">
      ...
      <nav className="flex items-center justify-center flex-wrap-reverse">
        ...
        <motion.a href="https://www.linkedin.com/in/dee-richards-435421289/" target={"_blank"}
         whileHover={{ y:-2 }}
         whileTap={{scale:0.9}}
         className="w-6 ml-3"
        >
